...
use crate::{
    Server,
    auth::{
        AccountCache, AccountInfo, AccountTenantIds, DomainCache, EmailCache, MailingListCache,
...
impl Server {
    ...
    pub async fn domain_by_id(&self, domain_id: u32) -> trc::Result<Arc<DomainCache>> {
        todo!()
    }
    ...
    pub async fn try_account(&self, id: u32) -> trc::Result<Option<Arc<AccountCache>>> {
        /*
    ...
    pub async fn account_id_from_email(
        ...
        let todo = "resolve subaddressing";
        todo!()
    }
